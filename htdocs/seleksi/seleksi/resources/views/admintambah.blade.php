...
<CENTER>
 ...
 <div class="form-row">
    ...
    <label for="lname">kode:</label>
  <input type="text"  name="kode" class="form-control"><br><br>
    </div>
     <div class="form-group col-md-6">
  ...
  <input type="text"  name="nama"  class="form-control"><br><br>
     ...
     <div class="form-group col-md-6">
  <label for="lname">Jabatan:</label><br>
  <input type="text"  name="jabatan" class="form-control"><br><br>
  <div class="form-group col-md-6">
  <label for="lname">nomor telepon:</label><br>
  <input type="text"  name="no_telp"  class="form-control"><br><br>
  </div>
  <div class="form-group col-md-6">
